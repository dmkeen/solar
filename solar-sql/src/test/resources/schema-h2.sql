...
CREATE TABLE IF NOT EXISTS current_power (id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, epoch_timestamp BIGINT, generation NUMERIC(6,2), consumption NUMERIC(6,2))
CREATE TABLE IF NOT EXISTS generation_forecast (id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, pv_estimate DOUBLE, pv_estimate10 DOUBLE, pv_estimate90 DOUBLE, period_end_epoch BIGINT UNIQUE, period_length_seconds INT)
